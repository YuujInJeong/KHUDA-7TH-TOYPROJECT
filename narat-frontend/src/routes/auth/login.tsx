      ...
      <main className="flex-grow flex flex-col justify-center items-center px-4 py-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">당신은 바른 한국어 생활을 하고 계신가요?</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <h4 className="text-base font-medium text-gray-900">체계적인 한국어 학습</h4>
                  <p className="mt-1 text-sm text-gray-500">한국인이 주로 혼동하는 한국어 문법 실력을 체계적으로 검증합니다.</p>
                </div>
              </div>
